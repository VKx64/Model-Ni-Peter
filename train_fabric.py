...
# ==========================================
IMAGE_SIZE = (100, 100)
DATASET_DIR = "dataset/fabric"  # Single folder for both train and test images
IMAGE_MODEL_SAVE_PATH = "models/fabric_model.keras"
TFLITE_MODEL_SAVE_PATH = "models/fabric_model.tflite"  # Path to save the TFLite model
